...
# bash tests/st/run_distribute_test.sh /path/hccl.json 0 1 test_gpt2
...
def test_gpt2_fully_inference_rlhf():
    """
    Features: Test gpt2 rlhf
    Description: test gpt2 rlhf
    ...
    args = namedtuple("input_args",
                      ["dataset_dir", "sft_model_path", "reward_model_path", "critic_model_path", "save_data_file",
                       "align_type"])
    input_args = args(dataset_dir=get_testing_dataset_path("cvalues_1024"),
                      sft_model_path=f"{root_path}model_configs/gpt2_config/run_gpt2_124m.yaml",
                      reward_model_path=f"{root_path}model_configs/gpt2_config/run_gpt2_124m.yaml",
                      critic_model_path=f"{root_path}model_configs/gpt2_config/run_gpt2_124m.yaml",
                      save_data_file="",
                      align_type="")
...
@pytest.mark.platform_x86_ascend_training
@pytest.mark.env_onecard
def test_gpt2_incre_inference_rlhf():
    """
    Features: Test gpt2 rlhf
    Description: test gpt2 rlhf
    Expectation: test pass
