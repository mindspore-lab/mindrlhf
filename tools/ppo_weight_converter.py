...
def get_converted_ckpt(mapped_params, weight_dict, seq_len):
    """
...
if __name__ == '__main__':
    ...
    ms_name = [
        "model.backbone.transformer.encoder.blocks.{}.layernorm1.gamma",
        "model.backbone.transformer.encoder.blocks.{}.layernorm1.beta",
        "model.backbone.transformer.encoder.blocks.{}.layernorm2.gamma",
        "model.backbone.transformer.encoder.blocks.{}.layernorm2.beta",
        "model.backbone.transformer.encoder.blocks.{}.attention.projection.weight",
        "model.backbone.transformer.encoder.blocks.{}.attention.projection.bias",
        "model.backbone.transformer.encoder.blocks.{}.attention.dense1.weight",
        "model.backbone.transformer.encoder.blocks.{}.attention.dense1.bias",
        "model.backbone.transformer.encoder.blocks.{}.attention.dense2.weight",
        "model.backbone.transformer.encoder.blocks.{}.attention.dense2.bias",
        "model.backbone.transformer.encoder.blocks.{}.attention.dense3.weight",
        "model.backbone.transformer.encoder.blocks.{}.attention.dense3.bias",
        "model.backbone.transformer.encoder.blocks.{}.output.mapping.weight",
        "model.backbone.transformer.encoder.blocks.{}.output.mapping.bias",
        "model.backbone.transformer.encoder.blocks.{}.output.projection.weight",
        "model.backbone.transformer.encoder.blocks.{}.output.projection.bias",
    ]
    ...
    addition_mindspore = [
        "model.backbone.layernorm.gamma",
        "model.backbone.layernorm.beta",
        "model.backbone.word_embedding.embedding_table",
        "model.backbone.position_embedding.embedding_table",
        "model.v_head0.weight", 
        "model.v_head0.bias", 
        "model.v_head0.weight", 
        "model.v_head0.bias" # for finetune
    ]
    ...
    new_ckpt = get_converted_ckpt(mapped_param, state_dict, opt.seq_len)
